...
<template>
  <div
    class="app_panelAddCategory p-2 bg-white border border-slate-200 rounded-lg shadow-sm flex items-center gap-2 cursor-pointer transition duration-200 hover:bg-slate-50"
    role="button"
    tabindex="0"
    @click="handleClick"
